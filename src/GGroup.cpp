...
void GGroup::_bind_methods()
{
    ...
    ClassDB::bind_method(D_METHOD("setLineGap", "value"), &GGroup::setLineGap);
    ClassDB::bind_method(D_METHOD("getLineGap"), &GGroup::getLineGap);

    ClassDB::bind_method(D_METHOD("setExcludeInvisibles", "value"), &GGroup::setExcludeInvisibles);
    ClassDB::bind_method(D_METHOD("isExcludeInvisibles"), &GGroup::isExcludeInvisibles);

    ClassDB::bind_method(D_METHOD("setAutoSizeDisabled", "value"), &GGroup::setAutoSizeDisabled);
    ClassDB::bind_method(D_METHOD("isAutoSizeDisabled"), &GGroup::isAutoSizeDisabled);

    ClassDB::bind_method(D_METHOD("setMainGridIndex", "value"), &GGroup::setMainGridIndex);
    ClassDB::bind_method(D_METHOD("getMainGridIndex"), &GGroup::getMainGridIndex);

    ClassDB::bind_method(D_METHOD("setMainGridMinSize", "value"), &GGroup::setMainGridMinSize);
    ClassDB::bind_method(D_METHOD("getMainGridMinSize"), &GGroup::getMainGridMinSize);
}

void GGroup::gd_setLayout(int value) { setLayout(static_cast<GroupLayoutType>(value)); }
int GGroup::gd_getLayout() const { return static_cast<int>(getLayout()); }
